...
<body>
    ...
    <section id="header">
        ...
        <div>
            ...
            <?php  findUser("products") ?><li><a href="about.php">About</a></li>
    ...
    <section id="product1" class="section-p1">
        <?php 
        $catObject =new CategoriesDB();
        $do = $_GET['do'];
        $showCatName =$catObject->showCategoriesWithCondition($do);
        foreach ($showCatName as $element) {
            
            $_SESSION['name'] = $element['name'];
        ...
        <div class="pro-container">
            ...
            $showProduct = $productObject->showProductWithCategories();
            foreach ($showProduct as $element) {
                $_SESSION['priceP'] = $element['price'];
                ...
                <a href='sproduct.php?do=".$element['id']."'><i class='fal fa-shopping-cart cart'></i></a>
            </div>";
            $_SESSION['idproduct'] =$element['id'];
            }
